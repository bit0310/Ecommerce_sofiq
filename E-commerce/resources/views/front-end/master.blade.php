                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    ...
                                                    <li><a href="{{ route('category-product') }}">Wallets</a></li>
                                                    <li><a href="{{ route('category-product') }}">Shoes</a></li>
                                                    <li><a href="{{ route('category-product') }}">Watches</a></li>
                                                    <li><a href="{{ route('category-product') }}"> Underwear </a></li>
                                            ...
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    ...
                                                    <li><a href="{{ route('category-product') }}">Wallets,Bags</a></li>
                                                    <li><a href="{{ route('category-product') }}">Footwear</a></li>
                                                    <li><a href="{{ route('category-product') }}">Watches</a></li>
                                                    <li><a href="{{ route('category-product') }}">Accessories</a></li>
                                                    <li><a href="{{ route('category-product') }}">Jewellery</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product') }}"><img src="{{ asset('/') }}/front-end/images/woo.jpg" alt=" "/></a>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product') }}"><img src="{{ asset('/') }}/front-end/images/woo1.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
                                    ...
                                    <ul class="dropdown-menu multi-column columns-3">
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    <li><a href="{{route('category-product-Men')}}">Clothing</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Wallets</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Shoes</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Watches</a></li>
                                                    <li><a href="{{route('category-product-Men')}}"> Underwear </a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Accessories</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu2</h6>
                                                    <li><a href="{{route('category-product-Men')}}">Sunglasses</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Wallets,Bags</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Footwear</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Watches</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Accessories</a></li>
                                                    <li><a href="{{route('category-product-Men')}}">Jewellery</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{route('category-product-Men')}}"><img src="{{ asset('/') }}/front-end/images/woo3.jpg" alt=" "/></a>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{route('category-product-Men')}}"><img src="{{ asset('/') }}/front-end/images/woo4.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
