                                ...
                                <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Men's Wear</label>
                                    <ul>
                                        <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
                                            <ul>
                                                <li><a href="{{route('category-product-Men')}}">Shirts</a></li>
                                                <li><a href="{{route('category-product-Men')}}">Caps</a></li>
                                                <li><a href="{{route('category-product-Men')}}">Shoes</a></li>
                                                <li><a href="{{route('category-product-Men')}}">Pants</a></li>
                                                <li><a href="{{route('category-product-Men')}}">SunGlasses</a></li>
                                                <li><a href="{{route('category-product-Men')}}">Trousers</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="top-rates">
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ asset('singleProduct') }}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ asset('singleProduct') }}">Lorem ipsum dolor </a></h6>
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ asset('singleProduct') }}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r1.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ asset('singleProduct') }}">Duis aute irure </a></h6>
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ asset('singleProduct') }}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r2.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ asset('singleProduct') }}">Lorem ipsum dolor </a></h6>
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ asset('singleProduct') }}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r3.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ asset('singleProduct') }}">Ut enim ad minim </a></h6>
                                        ...
                                        <div class="product-tab">
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="{{ asset('singleProduct') }}">Sed ut perspiciatis unde</a></h6>
