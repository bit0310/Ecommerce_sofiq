                ...
                <div class="col-md-3 single-grid1">
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="{{route('singleProduct')}}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r.jpg" alt=""></a>
                        </div>
                        <div class="recent-right">
                            <h6 class="best2"><a href="{{route('singleProduct')}}">Lorem ipsum dolor </a></h6>
                            <div class="block">
                                <div class="starbox small ghosting"> </div>
                            </div>
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="{{route('singleProduct')}}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r1.jpg" alt=""></a>
                        </div>
                        <div class="recent-right">
                            <h6 class="best2"><a href="{{route('singleProduct')}}">Duis aute irure </a></h6>
                            <div class="block">
                                <div class="starbox small ghosting"> </div>
                            </div>
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="{{route('singleProduct')}}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r2.jpg" alt=""></a>
                        </div>
                        <div class="recent-right">
                            <h6 class="best2"><a href="{{route('singleProduct')}}">Lorem ipsum dolor </a></h6>
                            <div class="block">
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="{{route('singleProduct')}}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r3.jpg" alt=""></a>
                        </div>
                        <div class="recent-right">
                            <h6 class="best2"><a href="{{route('singleProduct')}}">Ut enim ad minim </a></h6>
                            <div class="block">
                                <div class="starbox small ghosting"> </div>
                            </div>
                    ...
                    <div class="col-md-4 product-grid">
                        <div id="owl-demo" class="owl-carousel">
                            ...
                            <div class="item">
                                <div class="recent-grids">
                                    <div class="recent-left">
                                        <a href="{{route('singleProduct')}}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r4.jpg" alt=""></a>
                                    </div>
                                    <div class="recent-right">
                                        <h6 class="best2"><a href="{{route('singleProduct')}}">Lorem ipsum dolor </a></h6>
                                        <div class="block">
                                ...
                                <div class="recent-grids">
                                    <div class="recent-left">
                                        <a href="{{route('singleProduct')}}"><img class="img-responsive " src="{{ asset('/') }}/front-end/images/r5.jpg" alt=""></a>
                                    </div>
                                    <div class="recent-right">
                                        <h6 class="best2"><a href="{{route('singleProduct')}}">Duis aute irure </a></h6>
                                        <div class="block">
            ...
            <div class="arrivals-grids">
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        ...
                        <div class="women">
                            <h6><a href="{{route('singleProduct')}}">Sed ut perspiciatis unde</a></h6>
                            <span class="size">XL / XXL / S </span>
